...
internal sealed class SefariaTanakhService : IDisposable
{
    ...
    public TanakhBookShape GetBookShape(string englishBookTitle)
    {
        ...
        var hebrewTitle = ResolvePreferredHebrewBookTitle(englishBookTitle, ExtractHebrewTitle(document.RootElement));
    ...
    public string GetPreferredBookHebrewTitle(string englishBookTitle)
    {
        return ResolvePreferredHebrewBookTitle(englishBookTitle, null);
    }
    ...
    private static void TryAddBook(JsonElement entry, IDictionary<string, SefariaBookInfo> target)
    {
        ...
        var hebrewTitle = ResolvePreferredHebrewBookTitle(englishTitle, ExtractHebrewTitle(entry));

        target[englishTitle] = new SefariaBookInfo(englishTitle, hebrewTitle);
    }

    private static string ResolvePreferredHebrewBookTitle(string englishTitle, string? apiHebrewTitle)
    {
        if (TanakhBookHebrewMap.TryGetValue(englishTitle, out var mappedTitle))
        {
            return mappedTitle;
        }

        return apiHebrewTitle ?? englishTitle;
    }
